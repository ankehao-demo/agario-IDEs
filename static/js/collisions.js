...
function resolvePlayerAICollision(playerCell, playerCellIndex, ai, aiIndex, state) {
    const { aiIndicesToRemove, playerCellsToRemove, scoreGains } = state;
...
export function handlePlayerAICollisions() {
    ...
    const state = { aiIndicesToRemove, playerCellsToRemove, scoreGains };
    ...
    gameState.playerCells.forEach((playerCell, playerCellIndex) => {
        ...
        gameState.aiPlayers.forEach((ai, aiIndex) => {
            resolvePlayerAICollision(playerCell, playerCellIndex, ai, aiIndex, state);
        });
    });
