...
function applyCollisionResults(context) {
    [...context.aiIndicesToRemove].sort((a, b) => b - a).forEach(index => {
    ...
    [...context.playerCellsToRemove].sort((a, b) => b - a).forEach(index => {
