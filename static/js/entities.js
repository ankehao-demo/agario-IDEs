...
function processCellPairForces(cell1, cell2, distance, canMerge, minMergeDistance, minDistance, cellsToMerge, i, j) {
...
function updateCellMerging() {
    ...
    for (let i = 0; i < gameState.playerCells.length; i++) {
        ...
        for (let j = i + 1; j < gameState.playerCells.length; j++) {
            ...
            processCellPairForces(cell1, cell2, distance, canMerge, minMergeDistance, minDistance, cellsToMerge, i, j);
        }
    }
