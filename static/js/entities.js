...
function applyForce(cell1, cell2, factor) {
...
function applyRepulsion(cell1, cell2, distance, minDistance) {
    ...
    applyForce(cell1, cell2, -repulsionFactor);
}
...
function applyAttraction(cell1, cell2, distance, canMerge) {
    ...
    applyForce(cell1, cell2, factor);
}

function processCellPairForces(cell1, cell2, distance, minMergeDistance, minDistance, canMerge, i, j, cellsToMerge) {
...
function updateCellMerging() {
    ...
    for (let i = 0; i < gameState.playerCells.length; i++) {
        ...
        for (let j = i + 1; j < gameState.playerCells.length; j++) {
            ...
            processCellPairForces(cell1, cell2, distance, minMergeDistance, minDistance, canMerge, i, j, cellsToMerge);
        }
    }
